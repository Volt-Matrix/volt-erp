          ...
          {filteredLeaves.map((leave) => (
            <tr key={leave.id} className={leave.status}>
                    ...
                    <button
                      onClick={() =>
                        handleAction(
                          leave.id,
                          "approved",
                          prompt("Enter manager comment for approval:"),
                        )
                      }
                      className="approve"
                    >
                    ...
                    <button
                      onClick={() =>
                        handleAction(
                          leave.id,
                          "rejected",
                          prompt("Enter manager comment for rejection:"),
                        )
                      }
                      className="reject"
                    >
              ...
              {(filter === "approved" || filter === "rejected") && (
                <td>
                  <textarea
                    value={leave.managerComment}
                    readOnly
                    className="mgr-comment"
                  />
                </td>
              )}
            </tr>
