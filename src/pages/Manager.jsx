  ...
  return (
    <div className="Repeat">
      <div className="header">
        <Link to="/Mpage" className="risk">
          <h5>Manager page</h5>
        </Link>
        <Link to="/Moverview" className="risk">
          <h5>Manager Overview</h5>
        </Link>
        <Link to="/Biodetail" className="risk">
          <h5>Bio metric</h5>
        </Link>
      </div>
          ...
          <div key={employee.id}>
            ...
            {expandedRow === employee.id && (
              <div className="Requirement">
                <p>
                  <strong>Present %:</strong> {employee.present}%
                  <span className="Battery large-battery present-battery">
                    <div
                      className="BatteryLevel"
                      style={{ width: `${employee.present}%` }}
                    ></div>
                  </span>
                </p>
                <p>
                  <strong>Absent %:</strong> {employee.absent}%
                  <span className="Battery large-battery absent-battery">
                    <div
                      className="BatteryLevel"
                      style={{ width: `${employee.absent}%` }}
                    ></div>
                  </span>
                </p>
                <p>
                  <strong>Half Days:</strong> {employee.halfDays}
                </p>
                <p>
                  <strong>Leaves Used:</strong> {employee.leavesUsed}
                  <span className="Battery large-battery leave-used-battery">
                    <div
                      className="BatteryLevel"
                      style={{ width: `${employee.leavesUsed * 10}%` }}
                    ></div>
                  </span>
                </p>
                <p>
                  ...
                  <span className="Battery large-battery leave-balance-battery">
                    <div
                      className="BatteryLevel"
                      style={{ width: `${employee.leaveBalance * 10}%` }}
                    ></div>
                  </span>
                </p>
              </div>
