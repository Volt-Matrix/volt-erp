  ...
  useEffect(() => {
    const fetchExcelData = async () => {
      try {
        ...
        const topProjects = [
          ...new Set(jsonData.map((r) => r.Project_ID)),
        ].slice(0, 5);
    ...
    <div>
      ...
      <div className="last">
        <div className="card-wide1">
          ...
          {filteredData.filter((r) => r.Delays && r.Delays !== "None").length >
          0 ? (
            filteredData
        ...
        <div className="card-wide1">
          ...
          {filteredData.filter(
            (r) => r.Safety_Issues && r.Safety_Issues !== "None",
          ).length > 0 ? (
            filteredData
